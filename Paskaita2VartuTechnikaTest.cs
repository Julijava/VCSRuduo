...
namespace VCSRuduo
{
    public class Paskaita2VartuTechnikaTest
    {
        ...
        public static void TestVartuTechnikaPage(string width, string height, bool automatika, bool montavimoDarbai, string result)
        {
            ...
            Assert.IsTrue(resultBox.Text.Contains(result), $"Result is not the same. Expected result is {result}, but was {resultBox.Text}");
        }
    }
}
